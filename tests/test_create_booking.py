...
def test_create_booking_with_custom_data(api_client):
    ...
    with allure.step('Verifying response data matches request data'):
        ...
        assert response['booking']['bookingdates']['checkin'] == booking_data['bookingdates']['checkin'], 'checkin date does not match with expected'
        assert response['booking']['bookingdates']['checkout'] == booking_data['bookingdates']['checkout'], 'checkout date does not match with expected'
        assert response['booking']['additionalneeds'] == booking_data['additionalneeds'], 'additional needs does not match with expected'
...
def test_totalprice_null(api_client, generate_booking_random_data):
    booking_data = generate_booking_random_data.copy()
...
def test_firstname_equals_int(api_client, generate_booking_random_data):
    booking_data = generate_booking_random_data.copy()
...
def test_lastname_equals_int(api_client, generate_booking_random_data):
    booking_data = generate_booking_random_data.copy()
...
def test_create_booking_without_obligatory_fields(api_client, generate_booking_random_data, obligatory_field):
    booking_data = generate_booking_random_data.copy()
